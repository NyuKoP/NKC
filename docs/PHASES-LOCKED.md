...
- `src/main/alternateRouteManager.ts`: alternateRoute lifecycle status and external proxy support.
- `src/main/routePolicy.ts`: routing mode semantics and strictness.
- `src/security/preferences.ts`: route/alternateRoute preference keys stability.
