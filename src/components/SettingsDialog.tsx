                ...
                <div className="grid gap-4 text-sm">
                  <div>
                    ...
                    <div className="mt-3 grid gap-2">
                      ...
                      <label className="flex items-center justify-between text-sm">
                        <span>External Onion (Tor/alternateRoute)</span>
                        <input
                          type="radio"
                          name="network-mode"
                  ...
                  <div className="text-xs text-nkc-muted leading-relaxed">
                    <p>Tor 또는 alternateRoute을 로컬에서 실행하고 SOCKS 프록시로 연결합니다.</p>
                ...
                <section className="rounded-nkc border border-nkc-border bg-nkc-panelMuted p-6">
                  <div className="grid gap-4 text-sm">
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="text-xs text-nkc-muted leading-relaxed">
                        <p>설치한 Tor/alternateRoute을 로컬에서 실행하고 SOCKS 프록시로 연결합니다.</p>
                        <p>
