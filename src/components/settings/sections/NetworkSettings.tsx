              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <span
                      title={t("alternateRoute ?곹깭", "alternateRoute status")}
                      className={`inline-flex h-2 w-2 rounded-full ${getDotClass(
            ...
            {connectionChoice === "alternateRouteOnion" ? (
              <div className="mt-3 border-t border-nkc-border pt-3">
                ...
                <div className="mt-2 text-xs text-nkc-muted">
                  {netConfig.alternateRoute.installed ? t("Status: installed", "Status: installed") : t("Status: not installed", "Status: not installed")}
                </div>
                {alternateRouteUpdateStatus ? (
                  ...
                  {!netConfig.alternateRoute.installed ? (
                    <>
                      <button
                        ...
                        className="rounded-nkc border border-nkc-border px-3 py-2 text-xs text-nkc-text hover:bg-nkc-panelMuted disabled:opacity-50"
                      >
                        {alternateRouteInstallBusy ? t("泥섎━ 以?..", "Working...") : t("?ㅼ튂", "Install")}
                      </button>
                      <button
                        type="button"
                        ...
                        className="rounded-nkc border border-nkc-border px-3 py-2 text-xs text-nkc-text hover:bg-nkc-panelMuted disabled:opacity-50"
                      >
                        {alternateRouteStatusBusy ? t("泥섎━ 以?..", "Working...") : t("?곹깭 ?뺤씤", "Check status")}
                      </button>
                    </>
                  ) : (
                    <>
                      <button
                        type="button"
                        onClick={() =>
                          void (alternateRouteConnected ? onDisconnectOnion("alternateRoute") : onConnectOnion("alternateRoute"))
                        }
                        disabled={
                        ...
                        className="rounded-nkc bg-nkc-accent px-3 py-2 text-xs font-semibold text-nkc-bg disabled:opacity-50"
                      >
                        {alternateRouteConnected ? t("?곌껐 ?댁젣", "Disconnect") : t("?곌껐", "Connect")}
                      </button>
                      <button
                        type="button"
                        onClick={() =>
                          alternateRouteUpdateAvailable ? void onApplyUpdate("alternateRoute") : void onCheckUpdates()
                        }
                      ...
                      <button
                        ...
                        className="rounded-nkc border border-nkc-border px-3 py-2 text-xs text-nkc-text hover:bg-nkc-panelMuted disabled:opacity-50"
                      >
                        {alternateRouteUninstallBusy ? t("泥섎━ 以?..", "Working...") : t("?쒓굅", "Uninstall")}
                      </button>
                      <button
                        type="button"
                        onClick={() => void onalternateRouteStatus()}
